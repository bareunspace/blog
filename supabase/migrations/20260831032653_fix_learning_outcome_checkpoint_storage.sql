...
begin
  ...
  loop
    ...
    loop
      ...
      set outcome_summary = jsonb_set(jsonb_set(coalesce(outcome_summary, '{}'::jsonb), '{checkpoints}', coalesce(outcome_summary->'checkpoints', '{}'::jsonb), true), array['checkpoints', v_checkpoint || 'd'], v_checkpoint_data, true),
