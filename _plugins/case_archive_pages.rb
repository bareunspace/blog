  ...
  class CaseArchivePagesGenerator < Jekyll::Generator
    ...
    def company_page_data(first_case, slug)
      company = first_case["company"].to_s.strip
      {
        ...
        "description" => "#{company}의 공개 전형에서 확인되는 말하기, 설명, 과제 수행, 카메라 응답 패턴과 준비 방향을 정리합니다.",
        ...
        "hero_description" => "공개된 전형에서 지원자에게 무엇을 직접 수행하도록 요구하는지와 그에 맞는 연습 방향을 확인합니다.",
        ...
        "archive_intro" => "각 사례가 보여주는 평가 방식과 실제 연습 방향을 확인합니다."
      }
    end
    ...
    def job_page_data(first_case, job_slug)
      job_label = human_job_label(job_slug)
      {
        ...
        "description" => "#{job_label} 직무의 공개 전형에서 반복되는 말하기, 설명, 과제 수행, 상황 대응, 카메라 응답 패턴과 준비 방향을 정리합니다.",
        ...
        "hero_description" => "같은 직무의 사례에서 반복되는 말하기·설명·과제 수행 방식과 준비 방향을 비교합니다.",
        "primary_cta_url" => first_related_url(first_case),
        "primary_cta_label" => first_related_label(first_case),
        ...
        "archive_intro" => "최근 전형에서 무엇을 직접 수행하도록 요구하는지와 그에 맞는 연습 방향을 비교합니다."
      }
    end
