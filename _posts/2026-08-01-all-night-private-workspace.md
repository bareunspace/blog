...
<main class="about-page all-night-private-workspace-page">
  ...
  {% include post-media-carousel.html
    ...
    image_src='/images/all-night-private-workspace.webp'
    image_alt='부천 밤샘 작업 공간이 필요한 순간을 위한 바른자리 올나잇 이미지'
    image_width='1672'
    image_height='941'
    image_loading='eager'
    image_caption='밤샘 작업이 필요한 순간에 맞춰, 방해받지 않는 집중 환경에서 시간을 채워보세요.'
  %}

  <nav class="guide-toc" aria-label="올나잇 상품 페이지 목차">
    <div class="guide-toc-inner">
      <span class="guide-toc-label">이 글에서 확인할 내용</span>
      <a href="#guide-overview">올나잇이 필요한 이유</a>
      <a href="#use-cases">활용 사례</a>
      <a href="#guide-info">이용 안내</a>
  ...
  <section id="guide-overview" class="guide-summary-section" aria-label="올나잇 상품 요약">
    <div class="section-inner guide-summary-grid">
      <article class="guide-summary-card">
        <span>01</span>
        <h2>밤의 집중력을 지키는 공간</h2>
        <p>카페와 집은 모두 장점이 있지만, 늦은 밤에는 방해 요소가 많아 오래 집중하기 어렵습니다. 올나잇은 그 시간을 깔끔하게 이어갈 수 있는 공간입니다.</p>
      </article>
      <article class="guide-summary-card">
        <span>02</span>
        <h2>총 6시간의 단독 이용</h2>
        <p>00:00부터 06:00까지, 정해진 시간 동안 공간을 한 팀이 단독으로 사용합니다. 길게 이어지는 작업 흐름을 끊지 않고 마무리할 수 있습니다.</p>
      </article>
      <article class="guide-summary-card">
        <span>03</span>
        <h2>작업과 회의, 연습까지 연결</h2>
        <p>개인 작업, 포트폴리오 정리, 회의, 발표 연습, 팀 프로젝트까지 다양한 목적에 맞게 활용할 수 있습니다.</p>
      </article>
    </div>
  </section>
  ...
  <section id="why-space-matters">
    <div class="section-inner">
      <h2 class="section-title">늦은 밤에도 이어지는 집중을 위해서</h2>
      <p class="section-desc">집에서는 휴대전화와 주변 사람의 움직임, 카페에서는 대화와 소음이 방해가 될 수 있습니다. 올나잇은 그런 방해를 줄이고, 해야 할 일에만 몰입할 수 있게 만드는 공간입니다.</p>
      <div class="about-highlight-grid" aria-label="올나잇이 필요한 이유">
        <article class="about-highlight-card">
          <h3>집중이 끊기는 밤</h3>
          <p>마감일이 가까워지거나 결과물을 완성해야 할 때는 짧게 멈추는 것이 오히려 흐름을 깨뜨립니다.</p>
        </article>
        <article class="about-highlight-card">
          <h3>말하기와 회의가 필요한 밤</h3>
          <p>면접 연습, 발표 리허설, 화상회의는 집이나 카페에서 이어가기 어려운 경우가 많습니다.</p>
        </article>
        <article class="about-highlight-card">
          <h3>한 번에 끝내고 싶은 작업</h3>
          <p>포트폴리오, 자기소개서, 영상 편집, 팀 프로젝트처럼 긴 호흡이 필요한 일은 충분한 시간을 확보해야 합니다.</p>
        </article>
      </div>
    </div>
  </section>
